...
#if FLOAT_BORDER_COLOR_PATCH
static char selfloatcolor[]              = "#42A5F5";
#endif // FLOAT_BORDER_COLOR_PATCH
...
#define TAGKEYS(KEY,TAG) \
	...
	{ MODKEY|MOD2KEY|ShiftMask,    KEY,      swaptags,       {.ui = 1 << TAG} }, \
	{ MODKEY|MOD2KEY,              KEY,      tagnextmon,     {.ui = 1 << TAG} }, \
	{ MODKEY|MOD2KEY|ControlMask,  KEY,      tagprevmon,     {.ui = 1 << TAG} },
...
static Key keys[] = {
	...
	#endif // SWITCHCOL_PATCH
	#if ROTATESTACK_PATCH
	{ MODKEY|MOD2KEY,              XK_j,          rotatestack,            {.i = +1 } },
	{ MODKEY|MOD2KEY,              XK_k,          rotatestack,            {.i = -1 } },
	#endif // ROTATESTACK_PATCH
	#if INPLACEROTATE_PATCH
	{ MODKEY|MOD2KEY|ShiftMask,    XK_j,          inplacerotate,          {.i = +1} },
	{ MODKEY|MOD2KEY|ShiftMask,    XK_k,          inplacerotate,          {.i = -1} },
	#endif // INPLACEROTATE_PATCH
	#if PUSH_PATCH || PUSH_NO_MASTER_PATCH
	...
	#endif // CFACTS_PATCH
	#if MOVERESIZE_PATCH
	{ MODKEY|MOD2KEY,              XK_Down,       moveresize,             {.v = "0x 25y 0w 0h" } },
	{ MODKEY|MOD2KEY,              XK_Up,         moveresize,             {.v = "0x -25y 0w 0h" } },
	{ MODKEY|MOD2KEY,              XK_Right,      moveresize,             {.v = "25x 0y 0w 0h" } },
	{ MODKEY|MOD2KEY,              XK_Left,       moveresize,             {.v = "-25x 0y 0w 0h" } },
	{ MODKEY|MOD2KEY|ShiftMask,    XK_Down,       moveresize,             {.v = "0x 0y 0w 25h" } },
	{ MODKEY|MOD2KEY|ShiftMask,    XK_Up,         moveresize,             {.v = "0x 0y 0w -25h" } },
	{ MODKEY|MOD2KEY|ShiftMask,    XK_Right,      moveresize,             {.v = "0x 0y 25w 0h" } },
	{ MODKEY|MOD2KEY|ShiftMask,    XK_Left,       moveresize,             {.v = "0x 0y -25w 0h" } },
	...
	{ MODKEY|ShiftMask,             XK_backslash,  shiftview,              { .i = +1 } },
  	#endif // SHIFTVIEW_PATCH
  	#if SHIFTVIEW_CLIENTS_PATCH
	{ MODKEY|MOD2KEY,              XK_Tab,        shiftviewclients,       { .i = -1 } },
	{ MODKEY|MOD2KEY,              XK_backslash,  shiftviewclients,       { .i = +1 } },
  	#endif // SHIFTVIEW_CLIENTS_PATCH
	#if AWESOMEBAR_PATCH
	...
	#endif // SCRATCHPADS_PATCH
	#if UNFLOATVISIBLE_PATCH
	{ MODKEY|MOD2KEY,              XK_space,      unfloatvisible,         {0} },
	...
	#endif // TAGALL_PATCH
	#if TAGALLMON_PATCH
	{ MODKEY|MOD2KEY|ShiftMask,    XK_comma,      tagallmon,              {.i = +1 } },
	{ MODKEY|MOD2KEY|ShiftMask,    XK_period,     tagallmon,              {.i = -1 } },
	#endif // TAGALLMON_PATCH
	#if TAGSWAPMON_PATCH
	{ MODKEY|MOD2KEY|ControlMask,  XK_comma,      tagswapmon,             {.i = +1 } },
	{ MODKEY|MOD2KEY|ControlMask,  XK_period,     tagswapmon,             {.i = -1 } },
	#endif // TAGSWAPMON_PATCH
	#if ALTERNATIVE_TAGS_PATCH
	...
	{ MODKEY|MOD2KEY,              XK_Up,         switchtag,              { .ui = SWITCHTAG_UP    | SWITCHTAG_TAG | SWITCHTAG_VIEW } },
	{ MODKEY|MOD2KEY,              XK_Down,       switchtag,              { .ui = SWITCHTAG_DOWN  | SWITCHTAG_TAG | SWITCHTAG_VIEW } },
	{ MODKEY|MOD2KEY,              XK_Right,      switchtag,              { .ui = SWITCHTAG_RIGHT | SWITCHTAG_TAG | SWITCHTAG_VIEW } },
	{ MODKEY|MOD2KEY,              XK_Left,       switchtag,              { .ui = SWITCHTAG_LEFT  | SWITCHTAG_TAG | SWITCHTAG_VIEW } },
	#endif // TAGGRID_PATCH
	#if MOVEPLACE_PATCH
